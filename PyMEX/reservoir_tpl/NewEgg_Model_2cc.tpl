...
*INCLUDE '/home/hygorcosta/Documentos/Phd/SAO/PyMEX/reservoir_tpl/egg_model/Egg_Model_Grid.inc'
...
*INCLUDE '/home/hygorcosta/Documentos/Phd/SAO/PyMEX/reservoir_tpl/egg_model/PERM_IMX_1.inc'
...
*WELL 'INJ1' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ1' *FULLY-MIXED
...
**
*WELL 'INJ2' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ2' *FULLY-MIXED
...
**
*WELL 'INJ3' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ3' *FULLY-MIXED
*INJECTOR *MOBWEIGHT 'INJ3'
*INCOMP *WATER
*OPERATE *MAX *STW 79.5  **m3/day
*OPERATE *MAX *BHP 42000
**$          rad  geofac  wfrac  skin
...
**
*WELL 'INJ4' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ4' *FULLY-MIXED
*INJECTOR *MOBWEIGHT 'INJ4'
*INCOMP *WATER
*OPERATE *MAX *STW 79.5  **m3/day
*OPERATE *MAX *BHP 42000  **kPa
**$          rad  geofac  wfrac  skin
...
**
*WELL 'INJ5' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ5' *FULLY-MIXED
*INJECTOR *MOBWEIGHT 'INJ5'
*INCOMP *WATER
*OPERATE *MAX *STW 79.5  **m3/day
*OPERATE *MAX *BHP 42000  **kPa
**$          rad  geofac  wfrac  skin
...
**
*WELL 'INJ6' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ6' *FULLY-MIXED
*INJECTOR *MOBWEIGHT 'INJ6'
*INCOMP *WATER
*OPERATE *MAX *STW 79.5  **m3/day
*OPERATE *MAX *BHP 42000  **kPa
**$          rad  geofac  wfrac  skin
...
**
*WELL 'INJ7' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ7' *FULLY-MIXED
*INJECTOR *MOBWEIGHT 'INJ7'
*INCOMP *WATER
*OPERATE *MAX *STW 79.5  **m3/day
*OPERATE *MAX *BHP 42000  **kPa
**$          rad  geofac  wfrac  skin
...
**
*WELL 'INJ8' *ATTACHTO 'EGGMODEL'
*XFLOW-MODEL 'INJ8' *FULLY-MIXED
*INJECTOR *MOBWEIGHT 'INJ8'
*INCOMP *WATER
*OPERATE *MAX *STW 79.5  **m3/day
*OPERATE *MAX *BHP 42000  **kPa
**$          rad  geofac  wfrac  skin
